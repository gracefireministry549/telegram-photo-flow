...
async def telegram_webhook(request: Request):
    """Receive Telegram updates and acknowledge photos safely."""
    ...
    if photo and chat_id is not None:
        await send_message(
            chat_id,
            "📷 Photo received successfully. Send the business details or lead information you want the agents to work on.",
        )
